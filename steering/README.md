...
| [votatis-data-issue-edit-app-token.md](votatis-data-issue-edit-app-token.md) | 3dulev/votatis-data 이슈는 gh 인증 계정으로 못 고침(레포 소유자 아님, 쓰기 권한 없음). votatis-bot App 자격증명(.prod.vars)으로 JWT→설치토큰→REST PATCH. 조회는 gh로 가능, 쓰기만 막힘. | pitfall, github, intake-api, ops | 2026-06-10 | 0 |
